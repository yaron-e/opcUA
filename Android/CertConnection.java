package com.example.opc_rtu_connection.remote;
...
public class CertConnection {
    ...
    public Completable startCertConnection() throws SecureIdentityException, ServerListException, IOException, SessionActivationException, URISyntaxException {
    ...
    MonitoredEventItemListener eventListener = new MyMonitoredEventItemListener(this, eventFieldNames);
...
class MyMonitoredDataItemListener implements MonitoredDataItemListener {
    private final CertConnection client;
    private final CertConnection certClient;

    public MyMonitoredDataItemListener(CertConnection certConnection) {
...
class MyMonitoredEventItemListener implements MonitoredEventItemListener {
    private final QualifiedName[] requestedEventFields;
    private final CertConnection certConnectionClient;

    public MyMonitoredEventItemListener(CertConnection certConnection, QualifiedName[] eventFieldNames) {
...
class MyReverseConnectionListener implements ReverseConnectionListener {
...
class MySubscriptionAliveListener implements SubscriptionAliveListener {
...
class MySubscriptionNotificationListener implements SubscriptionNotificationListener {
