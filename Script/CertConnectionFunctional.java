 ...
 */
public class CertConnectionFunctional {

	private static final Logger logger = LoggerFactory.getLogger(CertConnectionFunctional.class);
	...
	public static void main(String[] args) throws Exception {
		...
		CertConnectionFunctional sampleConsoleClient = new CertConnectionFunctional();
		try {
		...
		System.out.println(sampleConsoleClient.validationListener.toString());
	...
	public CertConnectionFunctional() {
	...
	protected void initialize() throws URISyntaxException, SecureIdentityException, IOException,
		...
		File derFile = new File(
				certStore.getBaseDir() + "/private/SampleConsoleClient@xubuntu-20.04.1-desktop_2048.der");
		File pemFile = new File(
				certStore.getBaseDir() + "/private/SampleConsoleClient@xubuntu-20.04.1-desktop_2048.pem");
		...
		logger.error("path to PKI found = " + privatePath.exists());
...
//        /* Enable renewing the certificate */true);
		final ApplicationIdentity identity = // createApplicationIdentity(privatePath, appDescription,
				...
				ApplicationIdentity.loadOrCreateCertificate(appDescription, "dataFEEDOpcUaClient",
						/* Private Key Password, optional */ "", /* Key File Path */privatePath,
						/* Enable renewing the certificate */ true);
